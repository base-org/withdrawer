...
require (
	...
	github.com/ethereum-optimism/optimism v1.7.1-0.20240307042524-89747141c859
...
replace github.com/ethereum/go-ethereum v1.13.11 => github.com/ethereum-optimism/op-geth v1.101308.3-rc.1
